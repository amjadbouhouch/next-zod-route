 ...
 */
type MiddlewareFunction<TContext = Record<string, unknown>, TNextContext = Record<string, unknown>, TMetadata = unknown> = (opts: {
    request: Request;
    ctx: TContext;
    metadata?: TMetadata;
 ...
 */
type MiddlewareFn<TContext, TReturnType, TMetadata = unknown> = {
    (opts: {
        context: TContext;
        request: Request;
        metadata?: TMetadata;
...
declare class RouteHandlerBuilder<TParams extends z__default.Schema = z__default.Schema, TQuery extends z__default.Schema = z__default.Schema, TBody extends z__default.Schema = z__default.Schema, TContext = {}, TMetadata extends z__default.Schema = z__default.Schema> {
    ...
    readonly middlewares: Array<MiddlewareFunction<TContext, Record<string, unknown>, z__default.infer<TMetadata>>>;
     ...
     * @returns A new instance of the RouteHandlerBuilder
     */
    use<TNestContext extends Record<string, unknown>>(middleware: MiddlewareFunction<TContext, TNestContext & TContext, z__default.infer<TMetadata>>): RouteHandlerBuilder<TParams, TQuery, TBody, TContext & TNestContext, TMetadata>;
    /**
